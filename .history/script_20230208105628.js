...
console.log(
  convertTitleCase('this is a nice LOOOOOOOFDSFSDF SFSDFSDFDSFDSFdsfSD title')
);
console.log(
  convertTitleCase(
    'dasdasdasaasdhidsadasdsads is a nice LOOOOOOOFDSFSDF SFSDFSDFDSFDSFdsfSD title'
  )
);
